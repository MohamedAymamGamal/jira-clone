          ...
          <Card>
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between ">
                ...
                <div>
                  <p className="text-sm sm:text-sm font-medium text-gray-600">total boards</p>
                  <p className="text-lg sm:text-lg font-bold text-gray-900" >{boards.length}</p>
          ...
          <Card>
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between ">
                ...
                <div>
                  <p className="text-sm sm:text-sm font-medium text-gray-600">recent activity</p>
